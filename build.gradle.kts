...
plugins {
    ...
    alias(libs.plugins.intellijPlatformMigration)
...
intellijPlatform {
    pluginConfiguration {
        ...
        val _untilBuild = if (providers.gradleProperty("pluginUntilBuild").get().isNotEmpty())
            providers.gradleProperty("pluginUntilBuild") else provider { null }
        ideaVersion {
            sinceBuild = providers.gradleProperty("pluginSinceBuild")
            untilBuild = _untilBuild
        }
