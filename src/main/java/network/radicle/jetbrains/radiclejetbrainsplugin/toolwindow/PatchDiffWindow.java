...
public class PatchDiffWindow extends DiffExtension {
    ...
    private void setupEditor(Editor editor, Change change, RadPatch patch, boolean isLeft) {
        ...
        EditorComponentInlaysManager inlaysManager = new EditorComponentInlaysManager(myEditor);
        ObservableThreadModel observableThreadModel = new ObservableThreadModel(change, patch.project, isLeft);
        patchDiffEditorGutterIconFactory = new PatchDiffEditorGutterIconFactory(inlaysManager, patch, observableThreadModel);
        ...
        patchReviewThreadsController = new PatchReviewThreadsController(inlaysManager, observableThreadModel, patch);
