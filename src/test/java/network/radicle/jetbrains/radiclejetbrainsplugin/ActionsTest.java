...
public class ActionsTest extends AbstractIT {
    ...
    public void radTrackAction() throws InterruptedException {
        ...
        assertThat(cmd).isNotNull();
        assertCmd(cmd);
        assertThat(cmd.getCommandLineString()).isEqualTo("wsl bash -ic \"/usr/bin/rad track --seed " + node.url() + " --remote\"");
    }
    ...
    public void radTrackPeerAction() throws InterruptedException {
        ...
        assertThat(cmd).isNotNull();
        assertCmd(cmd);
        assertThat(cmd.getCommandLineString()).isEqualTo("wsl bash -ic \"/usr/bin/rad track 123\"");
    }
